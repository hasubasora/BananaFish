    ...
    <yd-flexbox direction="vertical" class="info_top">
            ...
            <yd-flexbox-item>
                    ...
                    <yd-flexbox-item>
                        ...
                        <p class="JF_a"><span>我的积分</span><span>我的余额</span></p>
                        <p class="JF_b"><span>{{object.UserIntegral}} </span><span>￥{{object.Balance}}  </span></p>
                        </div>
                    </yd-flexbox-item>
                    <yd-flexbox-item >
                        <div class="infoJF"> 
...
export default {
  data() {
    return {
      object: [],
      list: [
        { title: "头筹订单", icon: "icon-tuan", style:"orange", url: "/TopGoodsList" },
        { title: "其他订单", icon: "icon-dingdan-copy",style:"orange", url: "/ShopGoodsList" },
        { title: "我的收益", icon: "icon-lirun2-copy", style:"orange",url: "" },
        { title: "邀请好友", icon: "icon-youhuiquan", style:"orange",url: "" },
        { title: "分红指数", icon: "icon-xianhua",style:"orange", url: "/RedData" },
        { title: "收货地址", icon: "icon-shouhuodizhi",style:"orange", url: "" },
        { title: "客服", icon: "icon-erji",style:"orange", url: "" },
        { title: "帮助", icon: "icon-hezuowoshouyouyihexiehepinggongyingxianxing", style:"orange",url: "" },
        { title: "商务合作", icon: "icon-hezuowoshouyouyihexiehepinggongyingxianxing", style:"orange",url: "" },
        { title: "设置", icon: "icon-shezhix",style:"orange", url: "" }
      ]
    };
  },
  created() {
