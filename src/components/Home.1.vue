    ...
    <div class="home">
        ...
        <yd-infinitescroll :callback="loadList" ref="infinitescrollDemo">
            <div class="index-content" slot="list" v-if="tab1 == 0">
                <div class="home-banner" :style="{background: topBgColor}">
                    <div class="swiper-wrap">
                        <yd-slider :callback="tabCallBack" :autoplay="5000" pagination-color="#fff" pagination-activecolor="#ffffff" :speed="100">
            ...
            <div class="list" slot="list" v-if="tab1 > 0">
                ...
                <swiper-slides-per-view :icon="hotIconUrl" :list="hotProducts"></swiper-slides-per-view>
                <div class="waterfall-flow-title">
