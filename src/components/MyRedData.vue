<template>
    ...
    <div class="RedDataTitle">
          <p><router-link to="/RedData" >平台分红数据</router-link >
          <router-link to="/MyRedData" class="write">我的分红数据</router-link ></p>
      </div>
        <yd-flexbox direction="vertical" class="RedData">
         ...
         <yd-cell-group>
            ...
            <yd-cell-item arrow>
                <span slot="left"> <i class="iconfont icon-lirun iconfonts"></i></span>
