    ...
    <div class="Invitations">
        ...
        <yd-flexbox direction="vertical">
            ...
            <yd-flexbox-item class="bbtm2bg">
                ...
                <p class="ptext">1. 好友在淘宝、超级返、商城返利、理财返利下单，单个商品实付金额>=6 9元，返利到账后，每邀请1位好友您将获得20元的现金奖励，多邀多得， 奖励无上限。（好友的订单不包括1元购、满减等活动订单，同时不包含虚 拟类目商品如话费充值、游戏点卡充值、购买网站会员等）。 2. 您每推荐一个好友注册</p>
    ...
    data() {
        return {
            ...
            goodsList: [
                {
                    image:
                        "http://images.bookuu.com/book_t/22/74/04/2274040-m.jpg"
                    // goodsName: "游戏中的数学文化",
                    // goodDes:
